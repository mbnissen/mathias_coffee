defmodule MathiasCoffeeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(MathiasCoffeeWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(MathiasCoffeeWeb.Gettext, "errors", msg, opts)
    # end
